...
echo ""
echo "Tier 1 (LD_PRELOAD for dynamic bionic binaries):"
echo "  Add to your shell profile:"
echo "    export LD_PRELOAD=\"$PREFIX/lib/libtermux-etc-redirect.so\${LD_PRELOAD:+:\$LD_PRELOAD}\""
echo ""
echo "Tier 2 (seccomp + ptrace for static Go binaries):"
echo "  Use as a wrapper:"
echo "    termux-etc-seccomp <command> [args...]"
echo "  Example:"
echo "    termux-etc-seccomp terraform init"
echo ""
echo "Tier 3 (narrow seccomp, no ptrace — for dynamic musl binaries):"
echo "  Use as a wrapper for Node/musl tools such as Claude Code:"
echo "    termux-etc-mount <command> [args...]"
echo "  Example:"
echo "    termux-etc-mount ~/.local/share/claude/versions/<ver> -p 'say ok'"
